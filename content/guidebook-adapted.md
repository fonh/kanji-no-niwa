...
9. **Classes de dresseurs additionnelles** — ✅ adopté (2026-07-01) : les 16 classes ci-dessous complètent les 10 historiques — **matériau de sourcing factuel uniquement** (qui existe dans le jeu d'origine, comment nommer les dresseurs) : la table « 27 classes » du PRD a été **retirée** le 2026-07-01 avec le mécanisme kanji_pool-par-classe, la référence croisée était morte *(corrigé 2026-07-07, audit 07, finding 07-E3)*.
...
11. **Kanji « signature » (Silver, Kimono Girls, Exécutifs Rocket — Rocket ajouté 2026-07-07, audit 07, finding 07-A2)** — les jeux de kanji cités par apparition/événement sont un motif narratif d'écriture uniquement *(précisé 2026-07-05, audit 01)* : jamais un pool de combat (les combats piochent les items étudiés — kanji + mots, tirage pondéré récent, audit 07), et jamais plus de 2 de ces kanji affichés comme inconnus sur un même dialogue (règle des 2 inconnus max de `curriculum-checkpoints.md` — « par page » corrigé en « par dialogue » par l'audit 04, aligné ici V-9, audit 07).

---

## Classes de dresseurs additionnelles (fusionnées au tableau PRD le 2026-07-01)

Le PRD ne couvrait à l'origine que 10 classes. Le guidebook en révèle 16 de plus — matériau de sourcing factuel (nommage, présence par zone), rien de mécanique. *(Colonne « Thème kanji proposé » supprimée 2026-07-07, audit 07, finding 07-E3 : trace directe du mécanisme kanji_pool-par-classe retiré le 2026-07-01 — aucun dresseur n'a de thème kanji, tout combat pioche le pool commun.)*

| Classe (VO) | Traduction proposée | Zones où elle apparaît |
|---|---|---|
| Camper / Picnicker | Campeur / Pique-niqueuse | Route 30, 35, National Park, Route 38/45 |
| Pokéfan | Passionné | Route 34, 35 |
| Beauty | Coquette | Goldenrod, Lighthouse, Route 37 |
| School Kid | Écolier | Route 38/39 |
| Psychic | Voyant | National Park, Route 26/39 |
| Black Belt | Karatéka | Cianwood Gym, Mt. Mortar, Route 45 |
| Sage | Sage | Sprout Tower |
| Medium | Médium | Ecruteak Gym |
| Skier / Boarder | Skieur / Surfeur des neiges | Mahogany Gym |
| Swimmer | Nageur/Nageuse | Route 40/41 |
| Scientist | Scientifique | Team Rocket HQ (Mahogany) |
| Poké Maniac | Collectionneur | Union Cave (réintégrée 2026-07-06, audit 04), Route 42/43, Mt. Mortar |
| Super Nerd | Intello | Goldenrod, Mt. Mortar |
| Gentleman | Gentleman | Lighthouse, Goldenrod |
| Twins | Jumeaux/Jumelles | Route 37, Dragon's Den |
| Ace Trainer (déjà au PRD) | Dresseur Ace | Toutes zones avancées |
...
- **Mom** — premier PNJ parlé ; signale que "Elm a demandé après toi", débloque sauvegarde/Sac/Carte Dresseur, remet le Pokégear à la sortie de la ville, juste avant le départ chez Mr. Pokémon *(corrigé 2026-07-17, audit New Bark : « au retour » rendait l'ordre d'Elm « appelle-moi en chemin » et les appels Route 30 injouables au 1ᵉʳ passage — fidélité HGSS = Pokégear avant Route 29)*.
...
- Pokégear → remis par Mom à la sortie de la ville, avant le départ chez Mr. Pokémon (voir PRD § Séquence d'ouverture) — fidèle HGSS, cf. correction audit 2026-07-17 ; porte l'appel quotidien du mentor actif (Elm puis Oak, voir PRD § Mentors) et les appels entrants du téléphone HGSS complet *(« sert aux push notifications » purgé 2026-07-06, chasse aux reliques audit 04 — vocabulaire web d'un ancien design)*
...
- **Mom** — rdc de la maison. Annonce qu'Elm demande après le joueur ; débloque sauvegarde/Sac/Carte Dresseur. Donne le Pokégear à la sortie de la ville, avant la 1ère course (fidélité HGSS, audit 2026-07-17). Plus tard propose de gérer une épargne sur les gains de combat.
...
**Sourcé du guidebook :**
- Pas de dresseur nommé sur cette route dans le texte d'origine (trop tôt — pas encore de Poké Balls) ; les « 8–10 dresseurs-combat » un temps envisagés sont **abandonnés** *(tranché 2026-07-07, synthèse, au grill — fidélité stricte : la route se traverse sans combat)*.
...
- Aucun dresseur nommé sur cette route dans le texte source (zone trop précoce — pas encore de Poké Balls). Les « 8–10 dresseurs-combat » un temps envisagés sont **abandonnés** *(tranché 2026-07-07, synthèse, au grill — fidélité stricte : la route se traverse sans combat, comme dans HGSS ; les 10 prototypes de `trainers.json` supprimés)*.
...
**Dans 漢字の庭 :**
- ✅ Positions dresseurs sur les deux routes — **2 nommés sourcés par route** (R30 : Joey/Wade ; R31 : Mikey/Don) + des dresseurs génériques mentionnés sans décompte par le guide *(« 5–6 par route » corrigé 2026-07-07, audit 07, finding 07-B2 : chiffre d'un ancien texte, non sourcé. **Tranché 2026-07-07, synthèse, au grill — fidélité stricte** : les slots par route = les nommés sourcés + les génériques que le guide mentionne, dénombrés à la passe contenu d'après la densité réelle de HGSS ; aucun dresseur sur les routes qui n'en ont pas — les 8-10 de Route 29 sont abandonnés)*
- 🔄 Dark Cave (entrée sur Route 31) → **Grotte Sombre** sur la carte — réintégration v1 actée (2026-07-06, « aucune v2 ») ; **chiffrée 2026-07-07, synthèse** : ligne dark-cave 700–760 dans la table de calibration, voir section route-45/dark-cave
...
- **Earl** — instituteur de "l'École Pokémon", trouvé errant entre le Gym et le Mart plutôt qu'à son école ; le joueur doit le ramener pour "commencer les cours". **Rôle adopté (2026-07-06, revue pédagogique #2) : l'École devient la salle de dictée** — écouter une phrase (audio existant) → la taper (clavier romaji→kana existant), niveaux croissants sur revisites ; candidate aussi comme lieu de remise du Carnet des compteurs (voir PRD § Kanjidex — confirmée, 08-D3). **Design réglé (2026-07-07, synthèse)** : audio VOICEVOX court (un mot au N5, une phrase courte dès N4) → saisie au clavier romaji→kana (le composant du mode Saisie, réutilisé tel quel), retry doux sans pénalité, zéro écriture SRS, récompense de collection.
...
- 🔄 Union Cave (HGSS) — relie Azalea à Goldenrod dans HGSS ; **réintégrée (2026-07-06, audit 04)**, voir section « Zones absentes ». **Budget chiffré 2026-07-07, synthèse : 140–175 kanji (chemin critique, entre Route 32 et Route 33)** — table de calibration.
...
- 🔄 **Puzzle Farfetch'd réintégré, adapté** (2026-07-06, audit 04 session 4, doctrine « tout utilisable » — remplace « supprimé ») : guider l'oiseau égaré de l'apprenti charbonnier à travers la forêt — puzzle spatial de guidage transposable tel quel (aucune mécanique de capture) ; **articulation réglée (2026-07-07, synthèse)** : puzzle résolu → `advance_quest` → retour au Maître du Charbon, dont le **texte obligatoire** remet 切 sous seuil de lecture N=12 (modèle CS standard, `content/texts-progressifs.md` § Condition d'activation) — le puzzle lui-même est pure navigation D-pad, aucun design supplémentaire requis
...
- ✅ **Pension (Day Care)** — bâtiment réel + couple sourcé (grands-parents de Lyra/Ethan). **Mécanique adoptée (2026-07-06, I-7) : le feuilleton des grands-parents** — une histoire à épisodes (séries graduées Tadoku, saisons de niveau croissant) ; un épisode par jour de visite (règle de fréquence `time_window`, comme Daisy/Moomoo), fin de saison → récompense cosmétique. Épisodes = collection du Sac (« carnet des histoires »), relisibles, **jamais dans `texts`** (règle P-15). L'option dépôt/maturation reste au dossier synthèse, conditionnée au concept « compagnon » (R10) — superposable plus tard.
...
**Sourcé du guidebook — PNJ clés :**
- La **pension (Day Care) est réintégrée en bâtiment de la Route 34 (tranché 2026-07-06, chasse aux reliques audit 04)** : le couple — en réalité les **grands-parents de Lyra/Ethan** — redevient des PNJ sourcés ordinaires, utilisables comme PNJ-leçon/texte par l'équipe contenu. **Mécanique adoptée — le feuilleton (2026-07-06, I-7, remplace l'orientation dépôt/maturation de la session 4) :** les grands-parents racontent une histoire à épisodes, un par jour de visite — lecture-plaisir en drip-feed, calée sur la cadence quotidienne, sans quiz-couperet. Voir la liste « Dans 漢字の庭 » ci-dessus pour le détail. L'ancien « supprimée dans 漢字の庭 » datait d'avant la doctrine de géographie complète.
...
- ✅ **Game Corner** — jetons + Coin Case fonctionnels, intérieur réel *(« supprimé » corrigé 2026-07-06, audit 04 session 4 — reliquat R8)*. **Design adopté (2026-07-06, I-3) — deux tables :** (1) **Kanji Flip**, adaptation de Voltorb Flip (le mini-jeu canonique du Game Corner HGSS européen) : grille 5×5 à indices de déduction **écrits en japonais** (lecture des nombres), retourner une tuile choisie exige une question éclair lecture/sens sur un kanji du `studiedSet` (zéro écriture SRS) — bonne réponse : la tuile se révèle ; mauvaise : compte comme piège, manche perdue ; niveaux croissants comme l'original ; (2) **discrimination de kanji jumeaux** (未/末、待/持…, revue pédagogique #6). Comptoir des prix : **cosmétique/collection uniquement** (décorations, skins) — aucun gate ne dépend des jetons, jamais d'achat de jetons. Réglages de production (niveaux, mises, prix du comptoir) : passe contenu — le design est complet (2026-07-07, synthèse).
- ✅ **Loterie** (Tour Radio 1F) — tirage quotidien « kanji du jour » *(« supprimée » corrigé 2026-07-06, audit 04 session 4 — reliquat R9 ; design I-4 adopté le même jour, voir l'inventaire PNJ ci-dessous)*
- ✅ **Global Terminal** — bâtiment réel, **fonction adoptée (2026-07-06, I-10) : la salle des collections** — expose tout ce qui se collectionne (Boules de Kurt, Plaques du capitaine, prises Safari, décorations, scores Pokéathlon, carnet des histoires de la pension) et **échange les doublons** contre jetons ou ¥ ; la chambre du joueur expose ses préférés, le Terminal est le catalogue complet *(remplace « fonction à designer à la synthèse » de la session 4)*
...
6. ✅ **Séquence confirmée (passe 2)** : Proton **apparaît bien en combat à la Tour Radio**, mais sur le 3F (après obtention de la Card Key), aux côtés de la 2e apparition de Petrel (déguisé, tout-Poison). La passe 1 n'avait pas retrouvé cette scène (perdue dans l'OCR). Séquence Tour Radio complète et confirmée : 1F (Sbire bloque, déguisement nécessaire) → rival démasque le déguisement en chemin vers 2F (il cherche en fait Lance, pas la Team Rocket) → 3F porte verrouillée (Card Key requise, obtenue via Tunnel de Doublonville) → 5F "Directeur" = **Petrel déguisé** (Zubat/Koffing/Raticate), sa défaite donne la Basement Key → Tunnel de Doublonville B2F : vrai Directeur captif, énigme d'interrupteurs (rouge/bleu/vert, indice "vert en dernier"), **rival (📍 Silver apparition #5 — Tunnel de Doublonville B2F, aligné avec la table PRD corrigée ; l'ancienne mention « PRD : Tour Radio B2F » était périmée, V-17, audit 07)** → retour Tour Radio 3F avec la Card Key : **Proton** (Golbat/Weezing) puis re-**Petrel** (5x Koffing + Weezing, tout Lévitation) → plateforme d'observation : **Ariana** (Arbok/Murkrow/Vileplume) puis **Archer** (Houndour/Houndoom/Koffing, révèle l'objectif = rappeler Giovanni) → le vrai Directeur arrive, donne la Plume Arc-en-ciel/Argentée.
...
- **Mr. Game** — Game Corner, donne le Coin Case. **Game Corner adapté en mini-jeu de kanji contre jetons (tranché 2026-07-06, chasse aux reliques audit 04 — remplace l'indécision « PNJ adaptable en autre chose »)** : les deux Game Corners (Doublonville, Céladia) deviennent des salles de mini-jeu pédagogique, le Coin Case retrouve sa fonction (porter les jetons) ; design I-3 complet, réglages (niveaux/mises) à la passe contenu (2026-07-07, synthèse).
...
- **Gérant du magasin de vélos** — prête une Bicyclette gratuitement ("bonne publicité"), mentionne que la chaîne est née à Cerulean City (Kanto) ; rappelle plus tard pour offrir le vélo définitivement. **Fonction adoptée (2026-07-06, I-11, clôt le candidat #3)** : la Bicyclette est l'objet-clé (`item_owned`) de la Cycling Road (gate sourcé) et double la vitesse de déplacement sur la carte.
...
- **Stand Loterie** (Tour Radio 1F) — tirage quotidien. **Design adopté (2026-07-06, I-4 — « kanji du jour », remplace le tirage sur ID du compagnon, ne dépend plus de ce concept)** : tirage quotidien d'un kanji, pondéré autour de la progression du joueur ; kanji **étudié** → jetons de Game Corner ; **maîtrisé** (doré, stabilité ≥ 14 j — seuil aligné 2026-07-07, audit 07) → décoration rare/cosmétique exclusif ; **inconnu** → lot de consolation + lien vers sa fiche Kanjidex. Lecture seule de l'état SRS (comme `studiedSet` en combat), aucune écriture. Barème chiffré à la synthèse.
- **Buena** — studio radio (Tour Radio 2F), donne la Blue Card, mot de passe quotidien à deviner pour gagner des points. **Boucle adoptée (2026-07-06, I-13 + revue pédagogique)** : le mot de passe s'entend à l'émission de 11h00 (exercice d'écoute : entendre → retenir → restituer au studio) ; les points de la Blue Card s'échangent au comptoir contre des cosmétiques, comme en jeu.
...
**Dans 漢字の庭 :**
- ✅ **Pokéathlon Dome** — Hub mini-jeux, accessible après Whitney. **Contenu des 4 disciplines adopté (2026-07-06, I-5 — le dôme est « la salle de fluence » : le chrono est son identité, exception assumée à la règle « aucun chrono » qui reste la loi des combats, précision ajoutée au PRD)** : **Reading Blitz** (mots du `studiedSet` défilants, choisir la lecture, combos, rythme croissant), **Word Forge** (former un max de mots valides à partir de tuiles kanji en 60 s), **Kanji Sprint** (taper les lectures au clavier romaji→kana contre la montre), **Chasse au Trésor** (retrouver le kanji/mot demandé dans une grille dense — entraînement au balayage visuel). `pokéathlon_score` = meilleur cumul des 4 (gate de Chuck : 250, atteignable en 1-2 sessions). Prize Shop rotatif : cosmétique/collection uniquement (décorations, Apriblender, accessoires). Tout pioche `studiedSet`, zéro écriture SRS. Barèmes de points : passe contenu (le design et le score — meilleur cumul des 4 — sont fixés ; 2026-07-07, synthèse).
- ✅ **Concours du Parc** *(réintégré session 4, doctrine « tout utilisable » — remplace « Bug Catching Contest supprimé » ; **design adopté 2026-07-06, I-6**)* : mar/jeu/sam (`time_window`, créneau sourcé C15), le parc passe en mode épreuve chronométrée courte — des trouvailles (mots/kanji sur tuiles) cachées dans les hautes herbes, chaque ramassage pose une question éclair lecture/sens, les trouvailles rares valent plus ; **le jury note la meilleure prise**, classement contre les concurrents sourcés, podium (décoration rare au 1er, baies/Apricorns, lot de participation, ruban de collection). Trouvailles = collection du Sac (règle P-15, jamais des `texts`), zéro écriture SRS. Réutilise la mécanique de balayage (Chasse au Trésor I-5) et le modèle de collecte Safari — un système, trois habillages. Barème de points : passe contenu (2026-07-07, synthèse).
...
- ✅ **Tour Jo** (Bell Tower) — **ascension réelle 1F→10F + toit** (séquence complète sourcée § Tour Jo ci-dessous, modèle set-piece ADR-0004 : un `zone_id` par palier ; danse rituelle des 5 Kimono Girls au sommet) *(« bâtiment tappable » corrigé 2026-07-06, chasse aux reliques audit 04 ; tile-authoring : passe assets ; budget : intérieur, hérite d'ecruteak-city — 2026-07-07, synthèse ; section d'inventaire PNJ déjà documentée § Tour Jo)*
...
- **Homme à l'énigme** — maison à l'ouest du Centre Pokémon, donne le Dowsing MCHN si bonne réponse ; la pièce contient aussi un livre relatant la légende des trois esprits et des deux tours (texte de lore tout trouvé). **Fonction du Dowsing MCHN adoptée (2026-07-06, I-9) : détecteur « chaud/froid » des objets-textes non lus** (`found_object_ref` sans ligne `text_completions` — « non découverts » corrigé 2026-07-07, audit 05, finding 05-D4 : l'état « découvert » n'existe pas dans le modèle des textes, qui ne connaît que lu/non lu) de la zone courante — l'outil de terrain qui accompagne les seuils de lecture des CS-Kanji (le Journal dit quoi chercher, le Dowsing aide où) ; fidèle à sa fonction d'origine.
...
- **Gauntlet des 5 Kimono Girls** (post-remise du grand texte d'Elm — « Master Ball » adapté en texte de lecture majeur, 2026-07-06, audit 04, voir PRD § Kimono Girls ; toutes réunies au Théâtre) — un combat chacune ; « un seul compagnon chacune / test du lien avec ton équipe » = flaveur de dialogue de l'original (compagnon défini 2026-07-07, synthèse : Pikachu cosmétique, PRD § Compagnon — aucune mécanique). Récompense : Clear Bell/Tidal Bell.
...
- 🔄 Mont Mortier → intérieur réintégré v1 (2026-07-06, « aucune v2 ») ; **chiffré 2026-07-07, synthèse : intérieur, hérite de la fenêtre mt-mortar (510–545)** — mini-donjon dōjō, voir note Karate King ci-dessous
...
- 🔄 Grotte Sombre → réintégration v1 actée (2026-07-06, « aucune v2 ») ; **chiffrée 2026-07-07, synthèse : ligne dark-cave 700–760** — tunnel à 2 entrées, gating à deux temps, homme aux BlackGlasses au fond (post-Antre du Dragon)
...
**Dans 漢字の庭 :**
- ❌ **Apparitions Silver bonus A/B supprimées** *(purgées 2026-07-07, synthèse, tranché au grill : ajouts narratifs du studio sans équivalent dans le jeu d'origine — politique zéro-invention. L'arc post-Johto de Silver est désormais entièrement porté par le sourcé : combat du Mont Lune → Tag Battle de l'Antre du Dragon → revanches hebdomadaires au Plateau Indigo (lundi/mercredi), voir PRD § Silver — arc Kanto)*.
...
- 📍 **Red** (Sommet) : 100 questions *(« 50 » corrigé 2026-07-07, synthèse — aligné audit 01, A-4)*, silence, neige, aucun dialogue. Red nod uniquement. Confirmé par recherche web (passe 3) : tempête de grêle au combat, silence total, disparition immédiate après défaite — voir `curriculum-checkpoints.md` pour le détail complet.
...
- **Intérieur *(complété 2026-07-07, audit 07, findings 07-C3/07-D7)* :** le **puzzle spatial HGSS d'origine est conservé** (pure navigation D-pad, jamais un gate de langue — chemin invisible de Morty, téléporteurs de Sabrina, glace de Pryce, tuiles-flèches de Blue… ; tile-authoring : passe assets, reste connu de la synthèse 2026-07-07) → 2 門弟 postés sur le parcours (dresseurs gardiens **sourcés** du gym) → porte du 師範 (verrouillée tant que les conditions ne sont pas remplies) → **試練 = l'examen à sections du 師範** (page de garde façon mini-JLPT, sections 文字・語彙 → 文法 → 読解 → 聴解 — enfin défini, voir PRD § Jalons-examens ; les intitulés 試練・空の道 etc. des fiches de zone sont les noms d'épreuve affichés sur cette page de garde) → relevé de notes → 印 ceremony
- **Condition visuelle :** porte du Gym barrée si conditions non remplies, ouverte sinon
- **Sourcé du guidebook :** le nombre réel de gardiens varie selon le Gym dans le jeu d'origine (2 à 5 selon la ville — Falkner et Bugsy en ont 2, Whitney et Morty en ont jusqu'à 4, Clair en a 5). Le PRD fixe une structure uniforme à 2 門弟 pour tous les gyms — choix de simplification cohérent, gardé tel quel, **avec une exception sourcée : Argenta/Brock, 0 門弟** (seul gym du jeu d'origine sans le moindre garde — tranché 2026-07-07, audit 07, plutôt que d'inventer 2 personnages) ; le détail ci-dessus est documenté pour mémoire.
...
**lecture** (seuil de textes lus `count(texts_read, N)` propre à chaque CS — voir PRD § CS-Kanji ; « tous les textes des zones débloquées lus » corrigé 2026-07-07, passe de vérification globale V-10 : reliquat du modèle `all_texts_read` retiré le 2026-07-06), pas de maîtrise.
...
| 登 (escalade) *(réintégré 2026-07-06, chasse aux reliques audit 04 — HM08 Rock Climb)* | Le Prof Chen/Oak, Bourg-Origine, après les 16 badges | Parois rocheuses (Mont Gris — terrain à exporter à la passe assets/tile-authoring, avec les 16 intérieurs de gym ; reste connu, synthèse 2026-07-07) |
...
terrain — passe assets/tile-authoring, reste connu de la synthèse 2026-07-07, comme au PRD.)*
...
**Règle générale (posée 2026-07-07, synthèse — solde 08-E2 « lignes manquantes ») : mapping identité.**
Toute zone qui existe dans HGSS utilise **sa propre piste d'origine** de l'OST HGSS (Route 32 → piste
« Route 32 » ou sa piste de groupe officielle, Safranville → « Saffron City », Mont Gris → « Mt.
Silver »…) — c'est une résolution mécanique à faire à la passe assets en dépouillant la tracklist
officielle, pas un choix éditorial ; il n'y a donc **pas de ligne à écrire par zone**. La table
ci-dessous ne liste que (a) les zones déjà mappées et (b) les **cas d'arbitrage** — zones sans piste
propre dans l'OST (ex. Ilex → piste Union Cave) ; à la passe assets, tout nouveau cas sans piste
dédiée (candidats : Îles Tourbillon, Cliff Cave, Routes Kanto groupées) reçoit sa ligne d'arbitrage
ici. Les intérieurs suivent la même règle (piste du bâtiment si elle existe, sinon piste de la zone
d'accès).
...
**Vermeille City (Lt. Surge)** — Pokémon Fan Club à l'ouest ; **✅ Salon du keigo (design adopté 2026-07-07, synthèse, tranché au grill — revue pédagogique, dernier trou de compétence)** : le Président du Fan Club anime un **mini-jeu dédié** dans une salle du club, « même intention, trois interlocuteurs » — une intention s'affiche (« demande-lui s'il a lu le document »), trois interlocuteurs face au joueur (ami / commerçant / supérieur), pour chacun choisir la formulation adaptée parmi 3-4 (QCM) ; sessions courtes (~5 intentions), contenu gradué N4→N2 selon la grammaire rencontrée, zéro écriture SRS, récompense de collection. **Variante professionnelle avancée (N2/N1) chez les réceptionnistes de la Silph Co.** (Safranville — keigo d'entreprise : guichet, téléphone, 二重敬語 à éviter). Le président garde aussi son rôle sourcé : il récompense qui écoute son histoire (bon modèle de PNJ-leçon "patience/politesse"). Gym au sud du Fan Club, un arbre à couper (切/Coupe — « 力 » corrigé 2026-07-07, synthèse, même coquille que V-13) ouvre l'accès à la clôture. Intérieur du Gym : grille de poubelles cachant deux interrupteurs à trouver avant d'atteindre Lt. Surge (bon gabarit de mini-puzzle pour notre Gym). Quête transversale : Copycat (habite Safranville) a perdu sa poupée ici — le joueur la récupère et doit la rapporter à Safranville (quête filée sur 2 villes). Suicune/Eusine peut apparaître ici (cohérent avec le fil Eusine déjà établi côté Johto).
...
**📍 Nouveau fil narratif confirmé passe 6 — le pont manquant entre Johto et Kanto pour l'arc du Rival :** en sortant de Route 3 (juste après Argenta/Pewter) vers la grotte du Mont Lune (Mt. Moon — zone jouable `mont-lune-route-3-4` de la table de calibration depuis le 2026-07-02 ; « hors scope en tant que donjon jouable » corrigé 2026-07-07, passe de vérification globale V-12, fossile d'avant la réintégration géographique complète), le Rival (Silver) tend une embuscade au joueur — sa première réapparition depuis le Hall of Fame. Le texte source le décrit reconnaissant enfin la valeur du joueur tout en voulant encore se battre. C'est ce combat qui, dans le jeu d'origine, précède et motive directement le combat en duo (**joueur + Rival contre Lance + Clair** — sens du duo corrigé 2026-07-07, synthèse, vérifié par recherche web : l'ancienne formulation « joueur + Lance contre le Rival » inversait les camps) déjà documenté côté Johto à l'Antre du Dragon/Blackthorn ("Tag Battle") — jusqu'ici cette section ne savait pas *pourquoi* le Rival se retrouvait mêlé à cette scène côté Johto ; cette embuscade Kanto en est l'origine chronologique. **Adopté comme vrai combat (2026-07-07, synthèse, tranché au grill — mécanique canonique HGSS vérifiée par recherche web)** : embuscade à la première entrée dans le Mont Lune, combat de 26 questions (N1, zone 1800–1820), suivi de la Tag Battle de l'Antre du Dragon (joueur + Silver contre Lance + Clair), puis des revanches hebdomadaires au Plateau Indigo (lundi/mercredi, `time_window`) — voir PRD § Silver — arc Kanto. Hors des « 6 Rencontres » de Johto, modélisé en `Quest` ordinaire `silver-kanto` ; il éclaire la caractérisation de l'Antre du Dragon déjà écrite (Silver y arrive après avoir, hors-écran, cherché le combat une fois de plus).

**Céladia / Celadon (Erika)** — Grand magasin (Celadon Department Store), Game Corner (casino — **adapté en mini-jeu de kanji contre jetons, aligné sur Doublonville/Mr. Game, tranché 2026-07-06, chasse aux reliques audit 04** ; remplace « à traiter comme décor » ; **design I-3 adopté le même jour : mêmes tables Kanji Flip + kanji jumeaux que Doublonville, mises plus grosses, pioche dans le `studiedSet` devenu N2/N1 — même salle, difficulté qui a grandi avec le joueur**), immeubles "Celadon Condominiums". Quête confirmée : un homme au sommet des Condominiums donne un objet uniquement de nuit (20h-4h) — bon modèle de PNJ à horaire fixe. **Callback confirmé vers Johto** : les masques (Turtwig/Chimchar/Piplup) obtenus ici sont utilisables au "Dress-Up Shop" du Tunnel de Doublonville (Goldenrod Tunnel) déjà présent dans notre jeu — lien concret entre Kanto et Johto à exploiter narrativement.

**Fuchsia City (Janine)** — Gym = labyrinthe de murs transparents (bon gabarit de Gym-puzzle, thème 毒/prudence — on ne voit pas le piège avant d'y être). Pal Park au nord — ✅ **tranché (2026-07-07, synthèse, au grill — F-A) : bâtiment à intérieur réel mais sans fonction** (le transfert inter-cartouches n'a aucun équivalent — classé avec le Battle Frontier, seules coupes assumées ; quelques PNJ d'ambiance + 1 texte secondaire dedans) ; le gardien reste confirmé comme "le fils de Baoba" — **callback direct vers un PNJ Johto déjà documenté** dans "PNJ récurrents transversaux". Volcan ayant coupé la route sud vers Île Braise (détour narratif tout trouvé).
...
- **Pr. Chen/Oak — évaluation du Pokédex** — ✅ **adapté (2026-07-07, synthèse, tranché au grill — F-A) : Oak évalue le Kanjidex** — quand on lui parle, il commente le nombre de kanji étudiés/maîtrisés par paliers de phrases (« 800 kanji étudiés… tu progresses bien ») ; pur dialogue, aucun système *(remplace « mécanique de complétion hors scope »)*.
...
- **Comptoir du Musée** — ✅ **tranché (2026-07-07, synthèse — F-A) : les panneaux d'exposition du Musée deviennent 3-4 textes secondaires N1** (`kind: sign`, fossiles/espace — le musée est une petite salle de lecture) ; la restauration fossile→compagnon reste sans équivalent (le compagnon est unique et cosmétique, voir PRD § Compagnon) *(remplace « mécanique de collection hors scope »)*.
...
- **"Réalisateur" GAME FREAK** — ✅ **adapté (2026-07-07, synthèse, tranché au grill — F-A) : la quête à 2 paliers porte sur le Kanjidex** — récompense de collection au jalon intermédiaire (`count(kanji_studied, 1000)`) et **diplôme des 2136** au jalon final (`count(kanji_studied, 2136)`), la récompense symbolique de fin de collection à côté de Red *(remplace « mécanique de collection hors scope »)*.
...
**Repère transversal confirmé (passe 7) :** Steven (Champion visiteur d'une autre région) forme un fil en 3 étapes traversant 3 villes — 1ère rencontre à Vermeille (déclenche une rencontre légendaire ailleurs), 2ᵉ rencontre silencieuse à Argenta (simple flag), résolution à Safranville (don ou échange). ✅ **Adopté (2026-07-07, synthèse, tranché au grill — F-A) : le fil sourcé en 3 étapes est conservé tel quel, déclenché post-Red comme dans l'original, récompense finale = objet de collection rare** (pas de compagnon à offrir — le compagnon est unique, voir PRD § Compagnon) ; `Quest` ordinaire `steven-fil` *(remplace « si le studio veut un fil similaire »)*.

**Dresseurs de Gym (avant le 師範) — ✅ nouveau, passe 6, lecture directe des sections de gym :** absent des passes précédentes, qui n'avaient que l'équipe du 師範 lui-même. Nombre et rareté des dresseurs "gardiens" avant le combat de Gym varient beaucoup d'une ville à l'autre — ce roster sert à **choisir les 2 門弟 sourcés** de chaque gym Kanto (structure uniforme du PRD, pas un nombre à calibrer par gym ; Brock = 0, exception sourcée — aligné 2026-07-07, audit 07, finding 07-D7 ; « SRS » purgé, audit 03) :
...
Noms et classes confirmés par lecture directe des sections de route du guide. Les classes sont du sourcing factuel pur (aucun thème kanji — voir note PRD "Suppression du mécanisme kanji_pool-par-classe" ; « thème kanji libre par classe » reformulé 2026-07-07, audit 07). *(⚠️ de couverture supprimé 2026-07-07, audit 07, finding 07-E5 : les routes 5, 6, 9, 10, 14 à 21 et 22 à 25 listées ici comme « sans roster » ont toutes reçu le leur à la passe 7 — voir § Kanto — Routes et donjons ci-dessus.)*
...
**À faire avant l'écriture de contenu Kanto détaillé :** les rosters de dresseurs *avant chaque 師範* sont couverts (tableau ci-dessus), et les rosters de routes le sont aussi depuis la passe 7 (§ Kanto — Routes et donjons ; « routes 5, 6, 9, 10, 14 à 21, 22 à 25 non couvertes » supprimé 2026-07-07, audit 07, finding 07-E5 — note d'avant la passe 7) ; restent à compléter : les équipes Pokémon de Misty/Erika/Brock/Blaine (hors-sujet pour l'adaptation — kanji/PNJ uniquement, cf. règles d'adaptation globales — donc faible priorité) et un calendrier PNJ complet équivalent à l'inventaire exhaustif du Johto. Priorité plus basse que le reste du jeu vu que Kanto est une extension de fin de partie (N1, ~1500-2000 kanji déjà maîtrisés par le joueur à ce stade).

---

## Zones absentes du jeu (v1) — **table caduque : réintégration générale (2026-07-06, audit 04)**

**✅ Décision tranchée au grill de l'audit 04 (2026-07-06) :** toute la **géographie traversable** de HGSS est réintégrée — « le vrai jeu, comme un émulateur » + « aucune v2 ». Sont réintégrées : Union Cave, Routes 41/43/46, intérieur des Ruines d'Alph, Îles Tourbillon (donjon optionnel — seul vrai terrain du CS 渦), **la Safari Zone en zone adaptée** (au lieu de Pokémon, on y attrape des contenus de lecture à collectionner — mangas, textes ; design détaillé le 2026-07-07, synthèse — voir la table des zones réintégrées ci-dessous), plus les zones **oubliées sans décision** par la passe Kanto : **Lavender Town** (et sa station radio — le directeur remet la carte EXPN après la quête de la Centrale, finding 04-B1) et **Routes 5/8/22**. **Seul le Battle Frontier reste hors scope** (système de combat annexe sans équivalent dans le jeu). Budgets kanji et insertion dans la table de calibration chiffrés à la synthèse (audit 09), même modèle que les réintégrations Grotte Sombre/Mont Mortier ci-dessous. La table d'origine est conservée pour référence de sourcing (dresseurs recensés par zone) :
...
|-----------|-------------------|------------|
| **Union Cave** | 🔄 Réintégrée (2026-07-06, audit 04) | Relie Route 32 à Route 33/Ecorcia dans HGSS — zone jouable réintégrée, **budget chiffré 2026-07-07, synthèse : 140–175 (chemin critique)**. Le guidebook y recense **7 dresseurs nommés** (Randonneurs, Maniaques, Dresseurs Ace) — **roster à reprendre** *(« aucun décor sur la carte / non repris, hors scope confirmé » supprimé 2026-07-07, audit 07, finding 07-E4 : le texte de traitement datait d'avant la réintégration et contredisait le statut de sa propre ligne)*. |
| **Route 41** | 🔄 Réintégrée (2026-07-06, audit 04 — défusionnée de Route 40) | Route maritime entre Route 40 et Cianwood, zone jouable à part entière depuis la défusion. Le guidebook y recense **~10 Nageurs** — roster propre à la Route 41 *(« fusionnés conceptuellement dans le pool Route 40 » supprimé 2026-07-07, audit 07, finding 07-E4 : contredisait la défusion actée sur la même ligne)*. |
...
| **Route 46** | 🔄 Réintégrée (2026-07-06, audit 04) | Petit connecteur au nord de Route 29, bloqué par un rebord à sens unique dans HGSS ; un seul dresseur (Randonneur) y est recensé — repris avec la zone. La grille de Route 29 devient un vrai accès différé (déjà noté § route-29) *(« Non repris — tease visuel sans zone jouable derrière » supprimé 2026-07-07, audit 07, finding 07-E4 : contredisait la réintégration et la note déjà corrigée de la section route-29)*. |
| **Ruins of Alph (intérieur)** | 🔄 Réintégré (2026-07-06, audit 04) | Les 4 salles intérieures rejoignent la zone extérieure (inscriptions + Rocket event) ; l'adaptation des puzzles Unown est **designée (2026-07-07, synthèse — c'est le #3 de la revue pédagogique, validé 2026-07-06)** : chaque salle-puzzle devient un **assemblage de kanji par composants/radicaux** (les tuiles-image de l'original transposées en tuiles-composants : recomposer le kanji demandé par le panneau-énigme), pioche `studiedSet` + `kanji_components` (KanjiVG), zéro écriture SRS ; le Rapport Unown = journal de fouille qui se remplit. |
| **Dark Cave (intérieur)** | 🔄 Réintégration v1 actée (2026-07-06, « aucune v2 ») | Entrée visible sur la carte ; tunnel à 2 entrées, gating à deux temps. Périmètre chiffré 2026-07-07, synthèse : ligne dark-cave 700–760 de la table de calibration. |
| **Mt. Mortar (intérieur)** | 🔄 Réintégration v1 actée (2026-07-06, « aucune v2 ») | Entrée visible sur la carte depuis Route 42. Le guidebook y documente un beat de "dojo caché" fort (voir section mt-mortar : Karate King Kiyo + 3 dresseurs). Périmètre chiffré 2026-07-07, synthèse : intérieur, hérite de la fenêtre mt-mortar (510–545) (impact progression). |
| **Routes 47/48, Cliff Cave, Safari Zone Gate** | 🔄 Réintégrées, Safari **adaptée** (2026-07-06, audit 04) | La mécanique de capture est remplacée : on y « attrape » des contenus de lecture à collectionner (mangas, textes) — **design détaillé (2026-07-07, synthèse)** : entrée par la porte de Baoba (fil D3) ; chaque jour, des objets-lecture apparaissent à des emplacements semi-aléatoires dans les aires ; **~3 prises par visite quotidienne** (l'économie de rareté du Safari original, transposée) ; les prises rejoignent la **collection du Sac** (règle P-15 : jamais des lignes de `texts`, hors `texts_read` et hors Journal), se lisent librement, doublons échangeables au Global Terminal (I-10) ; zone plateau 480–520, zéro écriture SRS. Redonne son payoff au fil Baoba (voir § PNJ récurrents transversaux). |
