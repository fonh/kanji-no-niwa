...
|---|---|---|---|
| Mom | PNJ ambiant, rdc de la maison ; annonce qu'Elm demande le joueur, débloque sauvegarde/Sac/Carte | Pokégear (après la 1ère course) | ambiant |
| Lyra/Ethan (rival/mentor) | Voisin·e déjà dresseur·euse, laisse un mail motivant sur le PC du joueur | — | ambiant |
...
| Policier | Enquête sur le cambriolage du labo, interroge sur le garçon roux | — | ambiant |
| Rival (Silver) | Aperçu en train d'espionner le labo | — | ambiant |
| Assistant du Pr. Elm | Comptoir du Mart, garde l'œuf mystère jusqu'au 1er badge | — | ambiant |
...
| PNJ / rôle sourcé | Rôle d'origine (jeu Pokémon) | Objet/quête remis | Type assigné |
|---|---|---|---|
| Lyra/Ethan | Attend sur la route une fois l'œuf livré, apprend au joueur à attraper (tutoriel) | — | ambiant |
...
| Employé Centre Pokémon | Signature de carte dresseur au 2F | — | ambiant |
...
| Jeune homme près de l'Apricorn noir | Quête de livraison ("porte ce message à mon contact", compagnon-courrier Kenya) | TM44 Rest | leçon #1 — 漢字: 死・漢・発・送・進 — 文法: それから、～ (sorekara、～)<br>leçon #2 — 漢字: 低・別・建・私・王 — 文法: だいたい〜 (daitai〜)<br>leçon #3 — 漢字: 竹・糸・又・寸・斤 — 文法: たいてい～ (taitei～)<br>leçon #4 — 漢字: 爪・戸・言・数・毛 — 文法: だから、～ (dakara、～) |
...
| Garçon blond | Près du Centre Pokémon, échange des Éclats contre des lots de Baies | Baies | leçon #2 — 漢字: 里・元・院・化・病・込 — 文法: どこへも Verb ません (doko e mo + Verb + masen) |
...
| PNJ / rôle sourcé | Rôle d'origine (jeu Pokémon) | Objet/quête remis | Type assigné |
|---|---|---|---|
| Sage Neal, Troy, Jin, Nico, Edmond, Chow | 6 Sages répartis sur les 3 étages | — | leçon #1 — 漢字: 干・年・尚・舌・面 — 文法: A とか B とか |
| Ancien Li | Sommet (3F), bat le joueur, explique la technique | TM70 Flash | leçon #2 — 漢字: 話・伝・候・兆・利 — 文法: A は B ほど～ありません (A wa B hodo ～ arimasen) |
...
| Homme sur le chemin | Cadeau gratuit sans condition | Graine Miracle | leçon #1 — 漢字: 説・豆・週・矢・医 — 文法: Noun に なる (Noun ni naru) |
...
| Homme près du pêcheur | Demande si le joueur collectionne les Apricorns | 2 Lure Balls | ambiant |
...
| PNJ / rôle sourcé | Rôle d'origine (jeu Pokémon) | Objet/quête remis | Type assigné |
|---|---|---|---|
| Jeune homme (salle souterraine) | Admiratif du 1er puzzle résolu, remet un journal qui s'auto-remplit | Rapport Unown | leçon #1 — 漢字: 知・無・短・学・映 — 文法: Verb た ところ (Verb ta tokoro)<br>leçon #3 — 漢字: 達・選・陸・類・久 — 文法: Verb ために (tame ni) |
| Chercheurs (PNJ ambiants) | Centre de Recherche des Ruines, discutent des découvertes | — | leçon #2 — 漢字: 老・臣・時・芸・衣 — 文法: Verb たほうがいい (〜ta hou ga ii)<br>leçon #4 — 漢字: 仏・任・価・保・修 — 文法: Verb つもり (〜tsumori) |
...
| Charcoal Man | Ses Farfetch'd-analogues se sont enfuis en Forêt Secte ; remet le Charbon une fois résolu | Charbon | leçon #1 — 漢字: 備・制・厚・師・得・復 — 文法: Verb て くる (Verb te kuru)<br>leçon #3 — 漢字: 準・演・犯・示・本・菜 — 文法: Verb て くれる (Verb-te kureru)<br>leçon #5 — 漢字: 限・険・雑・非・並・亡 — 文法: Verb てしまう (〜te shimau) |
| Sbire Rocket | Bloque l'entrée du Puits Ramoloss | — | ambiant |
| Vendeur du Mart | Comptoir du fond | Bloom Mail, Heal Ball, Net Ball (vente) | leçon #2 — 漢字: 快・接・殺・毒・比・減 — 文法: Verb てくれませんか (〜te kuremasen ka)<br>leçon #4 — 漢字: 自・貝・質・逆・過・適 — 文法: Verb て + さしあげる (Verb TE sashiageru) |
...
| PNJ / rôle sourcé | Rôle d'origine (jeu Pokémon) | Objet/quête remis | Type assigné |
|---|---|---|---|
| Kurt | Mène le joueur, se blesse au dos au pied de l'échelle, demande de continuer sans lui | — | ambiant |
...
| PNJ / rôle sourcé | Rôle d'origine (jeu Pokémon) | Objet/quête remis | Type assigné |
|---|---|---|---|
| Apprenti du Maître du Charbon | À l'entrée, enseigne la technique de capture des 2 fuyards | — | leçon #1 — 漢字: 冊・処・刻・劇・卵・宅 — 文法: Verb られる (〜rareru)<br>leçon #3 — 漢字: 校・飯・動・段・片・疑 — 文法: Verb ることができる (〜ru koto ga dekiru)<br>leçon #5 — 漢字: 難・革・了・偉・偶・刺 — 文法: Verb る ことになる (〜ru koto ni naru) |
| Kimono Girl Naoko | Plus au nord, perdue, demande le chemin de la sortie | — | ambiant |
| Jeune homme sur une corniche | Enseigne la technique "secouer les arbres" (Headbutt) | — | leçon #2 — 漢字: 宇・将・展・座・首・道 — 文法: Verb る ことがある (〜ru koto ga aru)<br>leçon #4 — 漢字: 痛・蒸・蔵・補・退・降 — 文法: Verb ることにする (〜ru koto ni suru) |
...
| Couple de la pension (grands-parents de Lyra/Ethan) | PNJ ambiant (Day Care supprimée dans 漢字の庭) | — | ambiant |
...
| Gérant du magasin de vélos | Prête une Bicyclette gratuitement, puis l'offre définitivement | Bicyclette | leçon #3 — 漢字: 沈・沸・浮・試・何・滴 — 文法: ～たら いかがですか (〜tara ikaga desu ka) |
| Fille évaluatrice d'affection | Maison au nord du Dept Store, évalue le lien avec le compagnon en tête | — | leçon #4 — 漢字: 使・働・甘・貸・舞・舟 — 文法: ～たら どうですか (〜tara doudesuka) |
...
| Name Rater | Maison nord de la ville, renomme les surnoms | — | leçon #6 — 漢字: 刀・弓・汽・羊・原 — 文法: ～だろう (〜darou) |
...
| Black Belt (sous-sol Dept Store) | Bloque l'accès avec ses conteneurs | — | ambiant |
...
| Sbire (déguisement) | Force le joueur à porter un déguisement Team Rocket | — | ambiant |
| "Directeur" = Exécutif Petrel déguisé (5F) | Boss d'étage, sa défaite donne la clé de sous-sol | Basement Key | combat |
| Vrai Directeur (otage, Tunnel B2F) | Délivré via la Basement Key | Carte-clé (Card Key) | ambiant |
| Rival (Silver) | Démasque le déguisement, combat (Silver apparition #5, en réalité Tunnel B2F, revisite tardive ~560+ kanji) | — | combat |
| Kimono Girl Kuni | Tunnel, après la Card Key (revisite tardive) | — | ambiant |
...
| Whitney (réapparition) | Accueil du Pokéathlon | Maillot porté en épreuve | ambiant |
...
| Bill | Centre Pokémon, repart pour Doublonville | — | ambiant |
...
| Homme au nord du Gym | Signale que le gardien-phare d'Oliville est malade | — | leçon #5 — 漢字: 撲・擁・敢・敷・斗・才 — 文法: ～てほしい (〜te hoshii) |
...
| Medium Martha/Edith/Grace/Georgina (Gym) | Récompense finale du Gym Morty | Fog Badge + TM30 Shadow Ball | ambiant |
...
| PNJ / rôle sourcé | Rôle d'origine (jeu Pokémon) | Objet/quête remis | Type assigné |
|---|---|---|---|
| Morty | Présent à l'arrivée avec Eusine, partage les découvertes sur les 3 esprits légendaires | — | ambiant |
| Eusine | Cherche spécifiquement le 3e esprit-kanji légendaire | — | ambiant |
| Firebreather Ned (1F), Richard (B1F) | Dresseurs de combat | — | combat |
| Rival (Silver) | Embuscade en haut de l'échelle vers B1F (Silver apparition #3, confirmé ici) | — | ambiant |
...
| Baoba | Gardien itinérant, 1ère rencontre ; annonce l'ouverture d'une réserve à Irisia | — | ambiant |
...
| Frère/sœur du jour Monica (lundi, plage) | PNJ calendaire | Sharp Beak | ambiant |
| Homme (Maison du Photographe, nord d'Irisia) | Révèle que le photographe itinérant récurrent est de sa famille | — | ambiant |
| Homme (ouest du Centre Pokémon d'Irisia) | Raconte la légende des 4 îles créées par le gardien légendaire des tourbillons | — | ambiant |
...
| PNJ / rôle sourcé | Rôle d'origine (jeu Pokémon) | Objet/quête remis | Type assigné |
|---|---|---|---|
| Le gardien de réserve (orig. Baoba) | Rencontré Route 39, rappelle par téléphone, revu à l'entrée de la Safari Zone (fil complet, Pokégear-Téléphone) | — | ambiant |
...
| Hiker anonyme | Sortant de Mont Mortier, bouscule le joueur et s'excuse | CS Force (力) | leçon #1 — 漢字: 氾・沃・淫・他・牙 — 文法: A あるいは B (A aruiwa B)<br>leçon #2 — 漢字: 瓦・痕・痩・瘍・稽 — 文法: A。おまけに B。(~omake ni)<br>leçon #3 — 漢字: 羞・臼・葛・蓋・蔑 — 文法: A。さて B。(A. Sate B.) |
...
| Scientist Gregg | Garde le PC qui coupe le système d'alarme du QG (B1F) | — | leçon #5 — 漢字: 千・右・名・天・倍 — 文法: A。それなのに B。(~sorenanoni) |
...
| Executive Petrel (déguisé en "Boss") | Salle du chef, retournement narratif (Zubat/Koffing/Raticate) | — | combat |
| Executive Ariana | Combat en double, aux côtés de Lance | — | combat |
| Skier/Boarder (Gym) | Récompense finale du Gym Pryce | Glacier Badge + TM07 Hail | ambiant |
...
| PNJ / rôle sourcé | Rôle d'origine (jeu Pokémon) | Objet/quête remis | Type assigné |
|---|---|---|---|
| PNJ à la grille de Route 43 | Mentionne que Mr. Pokémon cherche une Écaille Rouge | — | leçon #1 — 漢字: 左・列・男・白・花 — 文法: A。ということは B。 (A. To iu koto wa B.) |
...
| Fishing Guru | Concours du plus gros poisson-compagnon | Ether (record battu) | ambiant |
| Frère/sœur du jour Wesley (mercredi, post-QG) | PNJ calendaire | Black Belt (objet à équiper) | ambiant |
...
| PNJ / rôle sourcé | Rôle d'origine (jeu Pokémon) | Objet/quête remis | Type assigné |
|---|---|---|---|
| Kimono Girl Sayo | Coincée sur une plaque de glace près de la sortie, libérée en la poussant par derrière | — | ambiant |
...
| Maniaque des capacités | Contre une Écaille de Cœur, réapprend une capacité oubliée | — | leçon #3 — 漢字: 社・聞・言・間・電・安 — 文法: Noun の ことだから (Noun no koto dakara)<br>leçon #10 — 漢字: 遊・走・近・頭・主・事 — 文法: Noun を もとにして (Noun wo moto ni shite) |
...
| Homme bloquant l'Antre du Dragon | Refuse l'entrée tant que le badge de Gym n'est pas en poche | — | ambiant |
...
| Le Maître (Ancien) | Quiz d'empathie en 5 questions, condition réelle du 印 n°8 ; révèle être le grand-père de Clair/Lance | Cadeau de "successeur" | leçon #1 — 漢字: 堂・洗・玉・石・部・交 — 文法: ～たところ (〜ta tokoro)<br>leçon #3 — 漢字: 科・算・細・船・雪・雲 — 文法: ～だらけ (〜darake)<br>leçon #5 — 漢字: 反・取・受・号・向・君 — 文法: ～つつ (〜tsutsu)<br>leçon #7 — 漢字: 岸・島・州・幸・庫・庭 — 文法: ～っぱなし (〜ppanashi)<br>leçon #9 — 漢字: 期・根・様・橋・次・歯 — 文法: ～ていられない (〜te irarenai) |
...
| Homme à la Porte de Réception de la Ligue | Bloque l'est (Kanto) et l'ouest (Mont Gris) ; seul le nord (Route Victoire) est ouvert à ce stade | — | ambiant |
...
| Ouvrier | Propose un troc simple | Objet (troc) | ambiant |
...
| Grand-père de Bill (Chaumière au bord de mer) | Montrer un compagnon précis → objet évolutif au choix | Objet évolutif | ambiant |
| Misty (rendez-vous, bout de la route) | Scène climactique de poursuite de l'esprit légendaire, Eusine en commentateur | — | ambiant |
...
| Conseiller "Pouvoir Caché" | PNJ d'information gratuite près du Casino | — | leçon #6 — 漢字: 室・教・昼・歩・理・画 — 文法: Noun 並み (~nami)<br>leçon #12 — 漢字: 題・便・借・特・英・器 — 文法: Verb ざるを得ない (~ zaru wo enai)<br>leçon #18 — 漢字: 柱・植・油・泳・消・炭 — 文法: Verb そうもない (〜sou mo nai)<br>leçon #24 — 漢字: 希・府・徒・念・敗・最 — 文法: Verb たら最後 (〜tara saigo) |
...
| Fils de Baoba | Gère le Pal Park (callback direct vers un PNJ Johto déjà documenté) | — | ambiant |
...
| Rival (Silver, embuscade Mont Lune — **vrai combat adopté 2026-07-07, synthèse** : 26 questions N1, quête `silver-kanto`, hors "6 Rencontres" ; déclenche la Tag Battle de l'Antre puis les revanches hebdo au Plateau Indigo — voir PRD § Silver — arc Kanto) | Motive la Tag Battle de l'Antre du Dragon déjà documentée côté Johto | — | combat |
...
| PNJ / rôle sourcé | Rôle d'origine (jeu Pokémon) | Objet/quête remis | Type assigné |
|---|---|---|---|
| Vieil homme devant le Gym | Bloque puis laisse passer une fois la condition remplie (Gym fermé au 1er passage) | — | ambiant |
...
| Daisy (sœur de Blue) | Toilette le compagnon du joueur tous les jours 15h–16h ; après 7 visites cumulées, donne le contact de Blue | Contact de Blue (combat de revanche post-16-badges) | ambiant |
| Mère de Red | Confirme que Red voyage, maison tenue en son absence | — | ambiant |
| Pr. Chen/Oak (PC) | Permet de lire un mail d'ambiance d'un collègue chercheur | — | ambiant |
| Pr. Chen/Oak (évaluation Pokédex) | Bilan périodique, en personne ou par téléphone | — | ambiant |
| Pr. Chen/Oak (1ère visite, juste après Vertville) | "Reviens une fois tous les badges Kanto en poche" — rien à donner encore | — | ambiant |
| Pr. Chen/Oak (2e visite, après Blue à Vertville) | Donne la permission d'accès au Mont Gris | Permission Mont Gris | ambiant |
| Pr. Chen/Oak (3e visite, après Red) | Choix de récompense symbolique, écho au tout premier choix de starter | Cadeau au choix | ambiant |
...
| PNJ / rôle sourcé | Rôle d'origine (jeu Pokémon) | Objet/quête remis | Type assigné |
|---|---|---|---|
| Blue (1ère rencontre) | Renvoie le joueur à plus tard ("plus de badges Kanto") | — | ambiant |
| Blue (revisite tardive, post-Rock Climb) | Donne un objet porté | Magmarizer | ambiant |
| Panneau de relocalisation du Gym | Objet de décor, pointe vers Seafoam Islands | — | ambiant |
...
| Dresseurs postés (Seafoam B2F) | Servent de "freins" pour stopper la glissade sur sol de glace (puzzle environnemental-social) | — | ambiant |
...
| PNJ / rôle sourcé | Rôle d'origine (jeu Pokémon) | Objet/quête remis | Type assigné |
|---|---|---|---|
| Note du Prof Elm | Message laissé, pas un PNJ en personne à ce stade ("full circle") | — | ambiant |
| Centre Pokémon (jonction Route 28 / entrée Mont Gris) | Dernière occasion de se préparer avant l'ascension | — | ambiant |
...
| PNJ / rôle sourcé | Rôle d'origine (jeu Pokémon) | Objet/quête remis | Type assigné |
|---|---|---|---|
| Le Grunt Solitaire (quête Rocket optionnelle) | Attend Giovanni, pas de combat — dialogue mélancolique ("Team Rocket s'est dissous") | — | ambiant |
...
| PNJ / rôle sourcé | Rôle d'origine (jeu Pokémon) | Objet/quête remis | Type assigné |
|---|---|---|---|
| Red | 100 questions (HP battle — « 50 » corrigé 2026-07-05, audit 01, aligné PRD), silence total, tempête de grêle permanente ; disparaît immédiatement après défaite | Ruban de Légende | combat |
