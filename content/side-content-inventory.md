...
| A5 | Inscription au fond de l'antre, 4 lignes à traduire (N1, registre classique) | dragons-den | L924 | Déjà au PRD (NPC quest N1) ; **reward = Trophée Antre du Dragon** (item `unique` `trophee-antre` lu par les gates Suicune/Mont Gris/Red — défini 2026-07-07, synthèse) + lore + dialogue du mentor |
...
| F4 | Homme à l'énigme (bonne réponse → Dowsing MCHN — **détecteur de textes non lus, adopté 2026-07-06, I-9** ; « non découverts » corrigé 2026-07-07, audit 05, finding 05-D4) | ecruteak-city | L617, L623 | Question/réponse = format quiz naturel ; sa maison contient A2 |
...
| G3 | **Pokéathlon** — 4 disciplines **au contenu adopté (2026-07-06, I-5)** : Reading Blitz (lecture rapide), Word Forge (composition en rafale), Kanji Sprint (saisie chronométrée), Chasse au Trésor (balayage visuel) — « salle de fluence », seule exception chrono du jeu ; Prize Shop rotatif (cosmétique/collection) ; maillot de Whitney ; Apriblender | national-park | L540, L551, L558-559 | Condition de Chuck `pokéathlon_score ≥ 250` (au PRD depuis P-1) |
