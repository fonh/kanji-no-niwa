...
2026-07-07, audit 08, finding 08-B12)** : le gauntlet est une `Quest` ordinaire (`kimono-gauntlet`,
5 étapes = 5 combats) → `completed_quests[]` ; les gates « gauntlet Kimono vaincu » (Plateau Indigo,
Mont Gris, Red) et l'achievement se lisent en `Condition.quest_step` — `kimono_progress` ne trace que
