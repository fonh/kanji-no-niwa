...
| Onglet    | Contenu                                                 |
| --------- | ------------------------------------------------------- |
| Téléphone | Appeler Fukuda (lancer le SRS) *(« + messages des dresseurs » purgé 2026-07-06, audit 03, finding 03-C1 — trace d'un ancien design dresseur↔SRS supprimé, voir § Boucle Quotidienne « Combat et SRS sont indépendants »)* |
