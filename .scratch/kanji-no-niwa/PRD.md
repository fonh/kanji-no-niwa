...
| **Saisie** *(renommé 2026-07-06, audit 03 — anciennement « Écriture », nom trompeur : on **tape la lecture** au clavier, on ne trace jamais de kanji)* | Signification en anglais (non maîtrisé) ou prompt japonais (maîtrisé) | Clavier romaji→kana auto-converti (façon WaniKani, `wanakana`-like — remplace l'ancienne grille de tiles, 2026-07-02) — compose la lecture | Production active             |
...
**Graduation Sens/Saisie/Disposition (voir § Langue du Jeu, mécanismes A/B/C ; reformulé 2026-07-06, audit 03, finding 03-A2) :** l'anglais est le support de quiz d'un mot pendant sa phase d'acquisition ; une fois le mot **maîtrisé** (stabilité FSRS ≥ 30 jours), ces trois modes ne réaffichent plus jamais l'anglais — Sens pioche ses options dans les relations `related`/`antonym` de JMdict (fallback anglais uniquement si l'entrée n'a aucune relation renseignée), Saisie/Disposition basculent sur un prompt directement japonais. C'est la règle qui fait foi (tranché au grill de l'audit 03) — l'ancienne promesse du mécanisme C (« anglais une seule fois, dès la première exposition ») a été réécrite en conséquence.
...
**Aucun chrono nulle part (précisé 2026-07-01)** : depuis la suppression du Critical Hit, plus aucun combat — route, boss, Red inclus — n'a de pression temporelle. Le joueur répond à son rythme ; la seule contrainte est le nombre d'erreurs tolérées (voir § Système de Combat — Barres de HP). *(Précision 2026-07-06, I-5 : cette règle est la loi des **combats**. Les mini-jeux du Pokéathlon sont l'exception assumée — le chrono y est l'identité du lieu, qui entraîne la fluence (répondre vite et sans effort) là où les combats mesurent la justesse ; voir `guidebook-adapted.md` § national-park.)*
...
| Table                | Contenu                                                                                                                                                                                                                |
| -------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `kanji`              | character, meanings, readings, etymology, mnemonic, jlpt_level, `lesson_examples[]` *(ajouté 2026-07-07, audit 06, finding 06-B1 : les 1-2 phrases d'exemple de la page kanji de l'écran-livre — {jp, en, audio_ref, source: tango \| generated} — produites au pipeline, hybride humain>TTS, voir § Leçons)*, `icon_ref` *(ajouté 2026-07-07, audit 06, finding 06-B2 : emoji du concept, mapping CLDR automatique relu, **nullable** — pas de match forcé)* |
| `words`              | word, reading, jlpt_level, compound_story, pitch_accent, `photo_ref` *(ajouté 2026-07-07, audit 06 — nullable : photo du deck Anki Core 2k/6k local (~2 000 mots courants), affichée sur la Carte Mot ; extraction au pipeline)* |
...
| VOICEVOX *(ajouté 2026-07-07, audit 06)* | Libre, crédit requis | TTS japonais — audio des phrases d'exemple générées (3-4 voix en rotation) + complément mode Écoute (déjà acté § Combat) |
